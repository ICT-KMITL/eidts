...
(function (e) {
    ...
    return e.widget("ui.draggable", e.ui.mouse, {
        ...
        , drag: function (t, i, s) {
            var n, a, o, r, h, l, u, d, c, f, p = s.options
                , m = p.snapTolerance
                , g = i.offset.left
            ...
            })), s.snapElements[c].snapping = !1) : ("inner" !== p.snapMode && (n = m >= Math.abs(u - _), a = m >= Math.abs(d - y), o = m >= Math.abs(h - v), r = m >= Math.abs(l - g), n && (i.position.top = s._convertPositionTo("relative", {
            ...
            }).left)), !s.snapElements[c].snapping && (n || a || o || r || f) && s.options.snap.snap && s.options.snap.snap.call(s.element, t, e.extend(s._uiHash(), {
                snapItem: s.snapElements[c].item
